  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div
          className={cn(
            'no-print flex flex-col border-r border-border flex-shrink-0 transition-all duration-200',
        ...
        {/* Collapse toggle */}
        <button
          className="no-print flex-shrink-0 flex items-center justify-center w-4 bg-muted/30 border-r border-border hover:bg-muted/60 transition-colors"
